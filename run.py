...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {android}; SAMSUNG SCH-I545 4G Build/LRX22C) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/2.1 Chrome/{versi_chrome} Mobile Safari/537.36 [FBAN/EMA;FBLC/de_DE;FBAV/{str(rr(1000,3000))}.0.0.{str(rr(1,300))}.{str(rr(1000,3500))};]"
	if ua in ugent:pass
