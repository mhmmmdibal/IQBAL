...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {versi_android}; itel A512W Build:{build}) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36 [FBAN/EMA;FBLC/de_DE;FBAV/{str(rr(100,500))}.0.0.{str(rr(1,50))}.{str(rr(1000,95000))};]"
	if ua in ugent:pass
