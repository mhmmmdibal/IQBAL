...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) facebook-nativefier-f52d2f/1.0.0 Chrome/53.0.2785.143 Electron/1.4.16 Safari/537.36 [FBAN/EMA;FBLC/de_DE;FBAV/{str(rr(1000,5000))}.0.0.{str(rr(1,500))}.{str(rr(1000,5500))};]"
	if ua in ugent:pass
