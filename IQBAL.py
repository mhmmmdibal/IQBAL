...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {versi_android} Build/{build}; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{versi_chrome} Mobile Safari/537.36 [FBAN/EMA;FBLC/en_US;FBAV/{str(rr(100,300))}.0.0.{str(rr(1,30))}.{str(rr(100,350))};]"
	if ua in ugent:pass
