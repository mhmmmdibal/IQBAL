...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {android}; 23090RA98G Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36[FBAN/EMA;FBLC/en_US;FBAV/{str(rr(100,4000))}.0.0.{str(rr(10,400))}.{str(rr(1000,4500))};]"
	if ua in ugent:pass
