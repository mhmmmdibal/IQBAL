...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {andorid}; PGT-N09 Build/HONORPGT-N29; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/454.1.0.49.104;] FBNV/1 [FBAN/EMA;FBLC/de_DE;FBAV/{str(rr(1000,5000))}.0.0.{str(rr(10,500))}.{str(rr(1000,5500))};]"
	if ua in ugent:pass
