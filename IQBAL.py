...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {android}; TB310FU Build/{build}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/{version} Chrome/{versi_chrome} Mobile Safari/537.36 [FBAN/EMA;FBLC/de_DE;FBAV/{str(rr(1000,5000))}.0.0.{str(rr(1,500))}.{str(rr(1000,5500))};]"
	if ua in ugent:pass
