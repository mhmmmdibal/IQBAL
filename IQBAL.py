...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {android}; SM-G532M Build/MMB29T; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36[FBAN/EMA;FBLC/en_US;FBAV/{str(rr(1000,10000))}.0.0.{str(rr(10,500))}.{str(rr(10000,9000000))};]"
	if ua in ugent:pass
