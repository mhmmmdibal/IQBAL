...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {android}; PGT-N09 Build/{build}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36 [FBAN/EMA;FBLC/de_DE;FBAV/{str(rr(1000,5000))}.0.0.{str(rr(10,500))}.{str(rr(1000,5500))};]"
	if ua in ugent:pass
