...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {android}; 6002 Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36 [FBAN/EMA;FBLC/de_DE;FBAV/{str(rr(1000,2000))}.0.0.{str(rr(1,200))}.{str(rr(1000,2500))};]"
	if ua in ugent:pass
