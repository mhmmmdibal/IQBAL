...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {versi_android}; LM-K315IM Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/453.0.0.40.107;] FBNV/1{str(rr(1000,4000))}.0.0.{str(rr(1,200))}.{str(rr(1000,4500))};]"
	if ua in ugent:pass
