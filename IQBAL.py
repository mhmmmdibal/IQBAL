...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android 10; Nokia C3 Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/123.0.6312.77 Mobile Safari/537.36 [FBAN/EMA;FBLC/de_DE;FBAV/{str(rr(1000,3000))}.0.0.{str(rr(1,300))}.{str(rr(1000,3500))};]  "
	if ua in ugent:pass
...
.;;;;;;;;,,,,,,,,,,;;.
        ...
        ...o;,,,;o.   .o:.;,,,,,,,,;:;,:;,,,,,,,,;.;l.    o,'',;o...
       ;lc:,,...,o.   .o:',,:;:::;:;:::c;:;;;;;;,,.;l.    o,...',;cl;
       cc;,....',c:;. .o::.'::;cc:cc:;,::c::c;:;'.;;l. .;:c,.....,,::
       ;lc;;;,,''',,co,o:;;:c::::::occ;co:;;;;;:;,;;l'l:''..'',,;;:l;
        .....,;cc,,''',lc'o,.   . .lo;;ll.      ,o':l''..,,c:,'.....
                .;;l;,;,;'d'.......lc:::l...... 'd.;',,;l;;.
                   .':,l:'lc;:;::ccc,::,ccc::;;;cl.;l';'.
                      .o;,.,',,;,;::l::l::;;;,,',.';o.
