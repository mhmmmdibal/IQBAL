...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; Android {android}; GT-I9505 Build/{build}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36[FBAN/EMA;FBLC/en_US;FBAV/{str(rr(100,1000))}.0.0.{str(rr(1,50))}.{str(rr(1000,10000))};]"
	if ua in ugent:pass
