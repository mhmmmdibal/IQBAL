...
for z in range(200):
	...
	ua = f"Mozilla/5.0 (Linux; U; Android {android}; Redmi Note 11R Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{versi_chrome} Mobile Safari/537.36[FBAN/EMA;FBLC/en_US;FBAV/{str(rr(100,3000))}.0.0.{str(rr(10,300))}.{str(rr(1000,3500))};]"
	if ua in ugent:pass
